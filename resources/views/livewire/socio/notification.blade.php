<div>
    <div class="flex justify-end">
        <div class="fixed top-24 right-10">
            ...
            <button onclick="notificationHandler(false)"  class="inline-flex items-center justify-center p-2 rounded-md text-gray-900 hover:text-gray-500 hover:bg-gray-100 bg-gray-200 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition" >
    ...
    <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
        <button onclick="notificationHandler(false)" class="hidden focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 focus:outline-none  py-2 px-10 rounded bg-indigo-600 hover:bg-indigo-700 text-white">Open Modal</button>
    </div>
    <div class="w-full h-full top-16 overflow-y-auto overflow-x-hidden fixed sticky-0 hidden" id="chec-div">
        <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
