        ...
        <div class="words sm:hidden bg-white pt-2 overflow-x-auto whitespace-no-wrap border-b-2 font-bold text-gray-700">
            <div class="flex justify-center">
                <a href="{{Route('socio.index.desktop')}}">
                 <div class="px-4 py-2 cursor-pointer hover:underline" >Riders</div>
                </a>
              <div class="px-4 py-2 cursor-pointer underline text-gray-900" >Eventos</div>
                <a href="{{Route('garage.vehiculos.registerindex.desktop')}}">
                    <div class="px-4 py-2 cursor-pointer hover:underline" >Bikes</div>
                </a>
