<x-app-layout>
    ...
    <main class="text-gray-900">
        ...
        <section class="bg-cover bg-center text-white h-screen" style="background-image: url({{asset('img/fondoledjpg.jpg'); }})">
            <div class="container mx-auto px-8 lg:flex items-center">
                ...
                <div class="text-center lg:text-left lg:w-full ">
                    <div  class="px-2 md:px-10 pb-20 pt-10 mx-1 md:mx-4 mb-4" style="background-color: rgb(0,0,0,0.5);">
                        ...
                        <p class="text-xl lg:text-2xl mt-6 font-light">¡Bienvenidos a Mago Led, el lugar donde tus sueños de iluminación cobran vida! Aquí podrás cotizar tu presupuesto a medida para transformar tu discoteca, bar o cualquier espacio en un verdadero espectáculo de luces LED. También te invitamos a unirte a nuestro exclusivo curso de magos, donde aprenderás todos los secretos y técnicas para crear instalaciones luminosas increíbles de la mano de los mejores expertos en Chile. ¡No esperes más para darle el toque mágico a tu negocio!
                        </p>
                    </div>
                    <p class="mt-8 md:mt-24 flex justify-center mt-auto ">
                        <button type="button"
                            class=" py-4 px-12 bg-teal-500 hover:bg-teal-600 rounded text-white">Comenzar</button>
                    </p>
                    </p>
                </div>
                <div class="lg:w-1/2 hidden">
                   <img src="{{asset('img/controlador.jpg'); }}" class="w-2/4 objet-contain" alt="">
                </div>
