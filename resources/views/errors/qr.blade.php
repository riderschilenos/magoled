<x-app-layout>
  ...
  <div class="w-9/12 m-auto py-8 flex items-center justify-center">
    <div class="bg-main-color flex justify-center pb-4 pt-6 z-10 my-6 rounded-lg"> 
        <div class="text-white text-center shadow overflow-hidden sm:rounded-lg pb-8">
  
 
            
                <p class="text-3xl md:text-8xl lg:text-3xl font-bold tracking-wider text-white my-4">¡Oops!</p>
                <p class="text-2xl md:text-3xl lg:text-5xl font-bold tracking-wider text-white my-4">Qr Sin Activar</p>
            
            <h1 class="text-2xl font-medium">El Kit Qr Nro: {{$qr->nro}} aun no es activado, puedes activarlo siguiendo las instrucciones impresas en el envase.</h1>
