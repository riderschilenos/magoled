<x-app-layout>
  <x-slot name="tl">
    ...
    <title>Resumen Inscripción</title>
        ...
        <div class="card">
            <div class="card-body">
              <div class="grid grid-cols-3">
                  ...
                  <h1 class="text-2xl font-bold text-center">Resumen Inscripción</h1>
              </div>
                    ...
                    <div class="flex">
                      ...
                      <div class="w-1/4">
                        <div class="relative mb-2">
                          ...
                          <div class="w-10 h-10 mx-auto @if($vehiculo->status == 1 || $vehiculo->status == 2) bg-white @else bg-green-500 @endif  border-2 border-gray-200 rounded-full text-lg text-white flex items-center">
                            <span class="text-center @if($vehiculo->status == 1 || $vehiculo->status == 2) text-gray-600 @else text-white @endif  w-full">
                              <svg class="w-full fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
