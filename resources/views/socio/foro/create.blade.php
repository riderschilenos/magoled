    ...
    <div class="container py-8 ">
        ...
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::open(['route'=>'foros.store','files'=>true , 'autocomplete'=>'off']) !!}
                    
               
                    @php
                        $categorias=['PUBLICO GENERAL'=>'PUBLICO GENERAL','DISCIPLINA'=>'FOROS POR DISCIPLINA','RESULTADOS'=>'RESULTADOS']
                    @endphp
                    ...
                    <div class="flex justify-end">
                        {!! Form::submit('Crear nuevo foro', ['class'=>'font-bold py-2 px-4 rounded bg-blue-500 text-white cursor-pointer']) !!}
                    </div>

                {!! Form::close() !!}
            </div>
            <div class="card-body">
                @livewire('socio.foros-list')
            </div>
        </div>
