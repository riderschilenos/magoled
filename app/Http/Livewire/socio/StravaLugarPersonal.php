...
class StravaLugarPersonal extends Component
{
    ...
    {   $atletas_stravas=User::select('users.id', 'users.name', 'users.profile_photo_path', DB::raw('COALESCE(SUM(activities.distance), 0) AS total_distance'))
        ...
        return view('livewire.socio.strava-lugar-personal',compact('atletas_stravas','atletas_stravas7dias','atletas_stravas7dias2','now'));
    }
}
